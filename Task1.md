...
В этом задании, мы создадим командный репозиторий и поделимся доступом с каждым_ой участником_цей команды. В результате у всех в команде будет своя локальная копия репозитория с финальным проектом, в которой можно вести работу над игрой. Это командное задание, в котором нужно будет участвовать всем, но выполнять разные действия. Делайте задание совместно, обсуждайте свои действия друг с другом.

## Инструкция

Выберите, кто будет создавать репозиторий. 

Далее первая часть инструкции для этого_й участника_цы команды.
...
На вкладке Settings, в панели выбери Collaborators, чтобы добавить остальных участников_ц команды.

<img src="https://github.com/copetonrob/YP_Unity_M4_W4/blob/main/img/collaborators.png" width="600"/>

Используйте поиск по имени в github, чтобы добавить всех сокомадников_ц.
...
Создай проект в Unity. Обсуди с командой версию проекта, она должна быть установлена у всех участников_ц команды.
...
Зайди на страницу репозитория по ссылке от первого_й участника_цы команды. Прими приглашение для совместной работы с репозиторием.
...
Каждый_ая участник_ца в итоге должен иметь один и тот же открытый проект Unity и открытый Github Desktop
